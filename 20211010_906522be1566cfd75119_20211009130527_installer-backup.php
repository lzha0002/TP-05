...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211010_906522be1566cfd75119_20211009130527_archive.zip';
	const ARCHIVE_SIZE		 = '401934136';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '906522b-09130527';
    const SECONDARY_PACKAGE_HASH = '470fed9-09130527';
	const VERSION			 = '1.4.2';
