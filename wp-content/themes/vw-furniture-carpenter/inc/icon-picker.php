...
class VW_Furniture_Carpenter_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-furniture-carpenter' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vw_furniture_carpenter_font_awesome_icon_array = vw_furniture_carpenter_font_awesome_icon_array();
                    foreach ($vw_furniture_carpenter_font_awesome_icon_array as $vw_furniture_carpenter_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_furniture_carpenter_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_furniture_carpenter_font_awesome_icon).'"></i>
                            <span class="vw-furniture-carpenter-social-class">'.esc_attr($vw_furniture_carpenter_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vw_furniture_carpenter_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-furniture-carpenter-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_furniture_carpenter_customizer_script' );

if(!function_exists('vw_furniture_carpenter_font_awesome_icon_array')){
    function vw_furniture_carpenter_font_awesome_icon_array(){
