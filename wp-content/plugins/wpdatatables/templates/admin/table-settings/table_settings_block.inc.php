            ...
            <div class="tab-content">
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label data-toggle="html-checkbox-premium-popover" data-placement="top" title=""
                                       ...
                                       class="ts-label"><i class="wpdt-icon-star-full m-r-5"
                                                           style="color: #FFC078;"></i><?php _e('Enable server-side processing', 'wpdatatables'); ?>
                                </label>
                            </div>
                            <!-- /Server side processing toggle -->
                        </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="display-settings">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-20 wdt-responsive-block">
                            ...
                            <h4 class="c-title-color m-b-2">
                                <span class="opacity-5"><?php _e('Responsiveness', 'wpdatatables'); ?></span>
                            ...
                            <div class="hidden" id="table-responsive-hint">
                                <div class="popover-heading">
                                    <span class="opacity-5"><?php _e('Responsive design', 'wpdatatables'); ?></span>
                                </div>
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label for="wdt-responsive" data-toggle="html-checkbox-premium-popover"
                                       ...
                                       class="ts-label"><i class="wpdt-icon-star-full m-r-5"
                                            ...
                                            class="opacity-6"><?php _e('Allow collapsing on mobiles and tablets', 'wpdatatables'); ?></span></label>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="table-sorting-filtering-settings">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-20">
                            ...
                            <h4 class="c-title-color m-b-2">
                                <span class="opacity-6"><?php _e('Advanced column filters', 'wpdatatables'); ?></span>
                            ...
                            <div class="hidden" id="advanced-filter-hint">
                                <div class="popover-heading">
                                    <span class="opacity-6"><?php _e('Advanced filter', 'wpdatatables'); ?></span>
                                </div>
                            ...
                            <div class="toggle-switch" data-ts-color="blue">
                                ...
                                <label for="wdt-advanced-filter" data-toggle="html-checkbox-premium-popover"
                                       ...
                                       class="ts-label"> <i class='wpdt-icon-star-full m-r-5'
                                                            style='color: #FFC078;'></i> <span
                                            class="opacity-6"><?php _e('Enable advanced column filters', 'wpdatatables'); ?></span></label>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 m-b-20 table-tools-include-html-block hidden">
                            ...
                            <div class="hidden" id="table-tools-html-hint">
                                ...
                                <div class="popover-body">
                                    <?php _e('If this is enabled, columns that contain HTML like (link, image, email, attachment or HTML) will be rendered as HTML in export files for CSV,Excel,Print and Copy export option.<br><br> NOTICE: Please note that in back-end it will be rendered settings buttons in headers as well, so please check this functionality on front-end.', 'wpdatatables'); ?>
                                </div>
                            </div>
                            <!-- /Hidden popover with image hint -->
                            <div class="toggle-switch" data-ts-color="blue">
                        ...
                        <div class="col-md-12 m-b-16">
                            <div class="text-center">
                                <i class="wpdt-icon-star-full m-r-5"
                                   style="color: #FFC078;"></i><strong><?php _e('This is a premium feature', 'wpdatatables'); ?></strong>
                                <p class="m-b-0"><?php _e('This feature is available only in premium version of wpDataTables', 'wpdatatables'); ?></p>
                                <p>
                                    <a style="font-family: Inter,serif;font-style: normal;font-weight: 600;font-size: 13px;line-height: 16px;color: #008CFF;"
                                       ...
                                       target="_blank"><?php _e('Compare and View Pricing', 'wpdatatables'); ?></a>
                                </p>
                            </div>
                            <p class="opacity-5"><?php _e('Placeholders can be understood as predefined ‘search and replace‘ templates; that will be replaced with some actual values at the execution time; usually this is used for SQL queries, but you can use it for filtering and editing for manual tables and only filtering for tables created from XML, JSON, Excel, CSV, Google Spreadsheet and PHP Serialized array.', 'wpdatatables'); ?></p>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-4 m-b-16">
                                ...
                                <div class="fg-line form-group m-b-0">
                                    ...
                                    <input id="wdt-user-last-name-placeholder" type="text"
                                           value="<?php echo $wdt_current_user->last_name; ?>"
                                           class="form-control input-sm" disabled
                                           placeholder="<?php _e('Default for table generation', 'wpdatatables'); ?>">
                                </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="customize-table-settings">
                    ...
                    <div role="tabpanel">
                        ...
                        <p style="font-size: 15px;opacity: 0.6"><?php _e('In premium version you can customize each table with different skin, font, background , colors and lot more. Checkout new table customize settings below.', 'wpdatatables'); ?></p>
                        <div class="opacity-5">
                            <ul class="tab-nav" role="tablist">
