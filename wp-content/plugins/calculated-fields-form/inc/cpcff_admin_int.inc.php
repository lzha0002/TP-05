...
<div id="metabox_basic_settings" class="postbox" >
 ...
 <br /><br /><br />
 <style>@media screen and (max-width:710px){.cff-plugin-logo-promote{display:none;}}</style>
<div style="border:1px solid #F0AD4E;background:#FBE6CA;padding:10px;color:#3c434a;">
    <a href="https://cff.dwbooster.com/download" target="_blank" style="text-decoration:none;float:left;" class="cff-plugin-logo-promote"><img src="https://ps.w.org/calculated-fields-form/assets/icon-256x256.jpg" style="width:125px;height:125px;border:2px solid white;margin-right:10px;margin-bottom:10px;"></a>
