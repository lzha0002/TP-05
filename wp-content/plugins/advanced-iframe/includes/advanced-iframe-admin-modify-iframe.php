...
if ($evanto || $isDemo) {
    aiPostboxOpen("id-advanced-hide", "Hide/cover parts of the iframe.", $closedArray); 
?>
    <p>
...
<?php if ($evanto || $isDemo) { ?>     
  <div class="hide-print">    <h4>
    ...
    <p>
      <?php _e('You can show a custom html inside the div you create. This makes it possible to show whatever you like over the other iframe. Also shortcodes are supported in the external file. You can use this file if you attach the id of the file to the style settings separated by a $. So 10,20,200,50,#ffffff$123,10 has to be used if your id is 123 (file name = hide_123.html)', 'advanced-iframe') ?>      
    </p>
    <p>
