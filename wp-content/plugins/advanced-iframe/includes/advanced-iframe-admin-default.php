...
?>	
      <p class="hide-print">
      <?php _e('Examples if you want to use several iframes with different settings. Also read the'); ?> <a target="_blank" href="//www.tinywebgallery.com/blog/advanced-iframe/advanced-iframe-faq">FAQ</a>:
      </p>
      <ul class="hide-print">
...
<?php  
		...
		printNumberInput(false,$devOptions, __('Width', 'advanced-iframe'), 'width', __('The width of the iframe. You can specify the value in px, %, em, pt, vh, vw, rem or ch. If you don\'t specify a unit px is assumed. Pro user can also do basic calculations here if you have e.g. a fix left navigation on a page. e.g. 100%-200px. See <a target="_blank" href="https://caniuse.com/calc">https://caniuse.com/calc</a> for supported browsers! Shortcode attribute: width=""', 'advanced-iframe'));
