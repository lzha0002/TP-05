...
This is the **LITE version** of the official [Vision Interactive - Image Map Builder for WordPress](https://1.envato.market/LXAjj) plugin which comes with support and doesn't have some limitations.  You can get it by visiting the CodeCanyon website and [buy the pro version](https://1.envato.market/LXAjj).
...
[buy the pro version](https://1.envato.market/LXAjj). Purchasing the plugin gets you access to the full version of the Vision plugin, automatic updates and support.
