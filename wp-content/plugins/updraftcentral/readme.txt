...
== Upgrade Notice ==
* 0.8.18 : FIX: Fix updraftvault layout. Fix tooltip issues. FIX: Fix sidebar's collapse/expand button issues. FIX: Fix content not changing when switching to another post or page when editing using the block editor in WordPress 5.7. FIX: Fix modal dialog on fullscreen.
