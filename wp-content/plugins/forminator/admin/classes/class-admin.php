	...
	public function show_addons_update_notice() {
        ...
        <div id="forminator-addons-update-notice" class="forminator-update-notice notice notice-info fui-wordpress-notice is-dismissible" data-nonce="<?php echo esc_attr( wp_create_nonce( 'forminator_dismiss_notification' ) ); ?>">
            ...
            <p><a type="button"
                ...
                <?php if ( ! $notice_later ) { ?>
                    <a href="#" class="forminator-notice-dismiss" data-prop="forminator_addons_update_<?php echo esc_attr( $version ); ?>later" style="margin-left: 11px; color: #555; line-height: 16px; font-weight: 500; text-decoration: none;" data-prop-value="<?php echo current_time( 'timestamp' ); ?>"><?php esc_html_e( 'Remind me later', 'forminator' ); ?></a>
                <?php } ?>
            </p>
