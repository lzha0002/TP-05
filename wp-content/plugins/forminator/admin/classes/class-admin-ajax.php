...
class Forminator_Admin_AJAX {
	...
	public function save_dashboard_settings() {
		...
		if ( isset( $_POST['editor_settings'] ) ) {
			update_option( "forminator_editor_settings", sanitize_text_field( $_POST['editor_settings'] ) );
		} else {
	...
	public function dismiss_notice() {
		...
		$input_value       = filter_input( INPUT_POST, 'value', FILTER_SANITIZE_STRING );
	...
	public function addons_page_actions() {
		...
		$action = str_replace( 'forminator_', '', $_REQUEST['action'] );
