											...
											if ( isset( $detail_item['type'] ) && ( 'stripe' === $detail_item['type'] || 'paypal' === $detail_item['type'] ) ) {
														...
														<table id="fui-table-<?php echo $detail_item['type']; ?>" class="sui-table sui-accordion fui-table-details">
															...
															<tbody>
                                                                ...
                                                                <tr class="<?php echo 'stripe' === $detail_item['type'] ? 'sui-accordion-item' : ''; ?>">
																	...
																	if ( 'stripe' ===  $detail_item['type'] && empty( $subscription_id ) ) {
												...
												<div class="sui-box-settings-col-2">
													...
													<?php if ( empty( $sub_entries ) ) { ?>
														...
														<?php } else if ( 'number' === $detail_item['type'] || 'currency' === $detail_item['type'] || 'calculation' === $detail_item['type'] ) {
															...
															<span class="sui-description" data-inputmask="'alias': 'decimal','rightAlign': false, 'digitsOptional': false, 'groupSeparator': '<?php echo esc_attr( $separator ); ?>', 'radixPoint': '<?php echo esc_attr( $point ); ?>', 'digits': '<?php echo esc_attr( $precision ); ?>'"><?php echo ( $detail_item['value'] );//phpcs:ignore -- html output intended ?></span>
