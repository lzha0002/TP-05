...
if ( ! $addons->is_installed ) {
	...
	if ( ! $addons->is_active ) {
		$actions['activate']    = array(
			'name'    => ( $addons->is_network_admin ? __( 'Network Activate', 'forminator' ) : __( 'Activate', 'forminator' ) ),
		...
		$main_actions['deactivate'] = array(
			'name'    => ( $addons->is_network_admin ? __( 'Network Deactivate', 'forminator' ) : __( 'Deactivate', 'forminator' ) ),
			'icon'    => 'sui-icon-power-on-off',
    ...
    <div class="sui-box forminator-addon-card">
            ...
            <div class="forminator-addon-card--body-right">
                ...
                <div class="forminator-addon-card--title">
                    ...
                    <div class="forminator-addon-card--tags">
                        ...
                        <span class="<?php echo $tags['class']; ?>"><?php echo $tags['label'] ?></span>

                        <?php if ( $addons->is_installed && $addons->has_update ) { ?>
        ...
        <div class="forminator-addon-card--footer">
            ...
            <div class="forminator-addon-card--footer-right">
                    ...
                    <?php if ( $addons->is_installed ) { ?>
                        ...
                        if ( $addons->is_active ) {
                            ...
                            Forminator_Admin_Addons_page::get_instance()->render_template(
                                ...
                                array(
                                    'compound' => true,
                                    'label'    => ( $addons->is_network_admin ? __( 'Network Deactivate', 'forminator' ) : __( 'Deactivate', 'forminator' ) ),
                                    'icon'     => 'power-on-off',
                                    'ghost'    => true,
                            ...
                            Forminator_Admin_Addons_page::get_instance()->render_template(
                                ...
                                array(
                                    'compound' => true,
                                    'label'    => ( $addons->is_network_admin ? __( 'Network Activate', 'forminator' ) : __( 'Activate', 'forminator' ) ),
                                    'icon'     => 'power-on-off',
                                    'color'    => 'blue',
                                    'class'    => 'addons-actions',
                                    'attrs'    => array(
                ...
                <?php } else { ?>
                    <a
                        href="https://premium.wpmudev.org/project/forminator-pro/"
                        target="_blank"
                        class="sui-button sui-button-purple"
                    >
                        <?php esc_html_e( 'Try Pro For Free', 'forminator' ); ?>
                    </a>
                <?php } ?>
